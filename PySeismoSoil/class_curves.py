...
class GGmax_Curve(Curve):
    ...
    def __init__(
        ...
        super(GGmax_Curve, self).__init__(
            data, strain_unit=strain_unit, interpolate=interpolate,
            min_strain=min_strain, max_strain=max_strain,
            n_pts=n_pts, log_scale=log_scale, check_values=check_values,
        )
...
class Multiple_Damping_Curves(Multiple_Curves):
    ...
    #--------------------------------------------------------------------------
    def get_curve_matrix(self, GGmax_filler_value=1.0):
        """
...
class Multiple_GGmax_Curves(Multiple_Curves):
    ...
    def __init__(self, filename_or_list_of_curves, *, sep='\t'):
        ...
        super(Multiple_GGmax_Curves, self).__init__(
            list_of_GGmax_curves, element_class=GGmax_Curve,
        )
    ...
    #--------------------------------------------------------------------------
    def get_curve_matrix(self, damping_filler_value=1.0):
        """
